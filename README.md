...
⚠️ **Workflow Note:** *After initial EDA in MySQL, the analysis shifts to Google Colab. Because the local dataset server imposes strict time limits, Colab provides the necessary cloud computing power to handle and process these large data volumes without interruption.*
